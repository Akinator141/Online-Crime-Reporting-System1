...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
      ...
      Incharge Name
      <input type="text"  name="location" placeholder="incharge name" required="" id="station" onfocusout="f1()"/>
      compliaint id
					<input type="text"  name="compliant id" placeholder="compliant id" required="" id="iname" onfocusout="f1()"/>
